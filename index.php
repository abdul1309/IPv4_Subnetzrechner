...
<body>
<form method="post" action="Cidr.php" class="boxIndex">
    <h1>Netzwerk Rechner</h1>
    <table>
        <tr>
            <?php
            print $ipAddress->render();
            $CIDRSuffix->setValue($array);
            print '<td>' . $CIDRSuffix->render() . '</td></tr>';
            print '<td>' . $submit->render() . '</td></tr>';
            ?>
            </table>
        </form>
    </body>
